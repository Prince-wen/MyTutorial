...
object b_Array {
  ...
  //todo 不可变数组
  //1)	基本语法
  def immutable1(args: Array[String]): Unit = {
    //（1）数组定义
  ...
  //2)	基本操作
  def immutable2(args: Array[String]): Unit = {
    // 创建数组的另外一种方式
  ...
  def mutable1(args: Array[String]): Unit = {
  ...
  //2)	基本操作
  //    import scala.collection.mutable.ArrayBuffer
  def mutable2(args: Array[String]): Unit = {
...
//  import scala.collection.mutable.ArrayBuffer
  def switch(args: Array[String]): Unit = {
